...
| Intended private remote               | `https://github.com/NouraldinFarge/SiteWipe`; maintainer/CODEOWNER `NouraldinFarge`; default branch `main`                                                                                                                                                                                                                                                         | Created and verified private                                                                 | Confirms the approved private destination only; public visibility remains separate                                                                                                                                                           |
