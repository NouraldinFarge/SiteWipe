...
Runtime PNGs are generated at 16, 32, 48, and 128 pixels with ImageMagick using a transparent-safe SVG render, Lanczos resize, and metadata stripping. Exact commands, tool version, output hashes, and approval state are recorded in `icon-provenance.json`.
