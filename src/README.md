...
`SiteWipe` is the owner-approved custom product identity, and MIT is the owner-approved first-party project license. Known exact-name browser-extension listings mean uniqueness and legal clearance are not claimed. Version `1.11.12` remains a private candidate rather than an approved public version, and this candidate must not be published or submitted to a browser store.
