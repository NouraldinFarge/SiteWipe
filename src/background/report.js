...
export function createReport(target, _input) {
  ...
  return {
    ...
    summary: {
      ...
      temporaryDnrShieldSkippedForNormalOnlyReview: false,
      ...
      allSitesAccessGranted: null,
      broadHostPermissionOriginsGranted: null,
      exactRequiredHostPermissionOriginsGranted: null,
